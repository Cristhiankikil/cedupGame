...
public class PerguntasTela {
	...
	public PerguntasTela(Game game){
	 ...
	 public void render(Graphics g, ArrayList<?> lista) throws ClassNotFoundException, SQLException {
	 ...
	 public void telaPergunta(Graphics g, ArrayList<?> lista ) throws ClassNotFoundException, SQLException {
